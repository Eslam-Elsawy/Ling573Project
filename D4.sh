...
cp outputs/entity_reranker_D4/devtest/* outputs/D4/devtest
cp outputs/entity_reranker_D4/eval/* outputs/D4/eval
...
cp evaluation/output/D4/eval_data/output.txt results/D4_rouge_scores.out.txt
